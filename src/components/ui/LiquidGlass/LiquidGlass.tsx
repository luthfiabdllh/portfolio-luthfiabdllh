...
export function LiquidGlass({
  ...
  const getIntensityClasses = () => {
    switch (intensity) {
      case "subtle":
        return "backdrop-blur-sm bg-white/5 border-2 border-white/10 hover:outline-1 outline-white/30 border-opacity-20 border-white/10"
      case "strong":
        return "backdrop-blur-3xl bg-white/20 border-2 border-white/30 hover:outline-1 outline-white/30 border-opacity-20 border-white/10"
      default:
        return "backdrop-blur-xl bg-white/10 border-2 border-white/20 hover:outline-1 outline-white/30 border-opacity-20 border-white/10"
    }
  }
